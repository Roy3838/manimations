...
class Interferometer_Pythagoras(MovingCameraScene):
    def construct(self):
        ...
        equation = MathTex(r"\Delta d", r"=" ,r"d_{2}" ,r"-" ,r"d_{1}", color=BLACK).move_to(3*UP)
        ...
        formulaso1 = MathTex(r"d_1^2",r"=",r"y^2", r"+", r"(x_0+x)^2").shift(UP*3+LEFT*3).set_color(BLACK)
        ...
        formulaso2 = MathTex(r"d_2^2",r"=",r"y^2", r"+", r"(x_0-x)^2").shift(UP*2+LEFT*3).set_color(BLACK)
        ...
        formulaso1_despejado = MathTex(r"d_1",r"=",r"\sqrt{y^{2}+\left(x_{0}+x\right)^{2}}").shift(UP*3+LEFT*3).set_color(BLACK)
        formulaso2_despejado = MathTex(r"d_2",r"=",r"\sqrt{y^{2}+\left(x_{0}-x\right)^{2}}").shift(UP*2+LEFT*3).set_color(BLACK)
        ...
        formula_final= MathTex(r"\Delta d", r"=" ,r"\sqrt{y^{2}+\left(x_{0}-x\right)^{2}}" ,r"-" ,r"\sqrt{y^{2}+\left(x_{0}+x\right)^{2}}", color=BLACK).move_to(4*UP)
